...
const s = {
  ...
  h3: { margin: 0, fontSize: 15, fontWeight: 700, color: "var(--rv-tinta)" },
  sub: { fontSize: 13, color: "var(--rv-texto-suave)" },
  muted: { color: "var(--rv-texto-suave)", margin: 0 },
  msg: { background: "var(--rv-azul-fundo)", border: "1px solid var(--rv-azul-borda)", color: "var(--rv-azul-texto)", borderRadius: 8, padding: "8px 12px", fontSize: 13, marginBottom: 12 },
  item: { border: "1px solid var(--rv-borda-suave)", borderRadius: 12, padding: 12, marginBottom: 10 },
  itemTopo: { display: "flex", justifyContent: "space-between", gap: 10, fontSize: 14, color: "var(--rv-tinta)", marginBottom: 3 },
  itemSub: { fontSize: 12, color: "var(--rv-texto-fraco)", marginBottom: 8 },
  tag: { fontStyle: "normal", fontSize: 11, fontWeight: 700, borderRadius: 6, padding: "2px 6px" },
  tagAmb: { background: "var(--rv-ambar-fundo)", color: "var(--rv-ambar-texto)" },
  tagNao: { background: "var(--rv-vermelho-fundo)", color: "var(--rv-vermelho-texto)" },
  busca: {},
  input: { width: "100%", padding: "9px 11px", borderRadius: 8, border: "1px solid var(--rv-borda-forte)", fontSize: 13, marginBottom: 8, boxSizing: "border-box" },
  cands: { display: "flex", flexDirection: "column", gap: 6 },
  btnCand: { textAlign: "left", background: "var(--rv-fundo-cartao)", border: "1px solid var(--rv-borda)", borderRadius: 8, padding: "8px 10px", fontSize: 13, color: "var(--rv-texto-forte)", cursor: "pointer" },
};
