...
const S = {
  card: {
    ...
    borderLeft: "4px solid var(--rv-borda)",
    borderRadius: 14,
    padding: 16,
    marginBottom: 12,
  ...
  cardAtivo: { borderLeftColor: "#2563eb", boxShadow: "0 0 0 2px var(--rv-azul-borda)" },
  topo: { display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start" },
  nome: { fontWeight: 700, color: "var(--rv-tinta)", fontSize: 15 },
  sub: { fontSize: 12.5, color: "var(--rv-texto-fraco)", marginTop: 2 },
  metaLinha: { display: "flex", flexWrap: "wrap", gap: 12, marginTop: 6 },
  meta: { fontSize: 12.5, color: "var(--rv-texto-suave)" },
  badgesDir: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6 },
  badgeSituacao: {
    display: "inline-block", padding: "3px 9px", borderRadius: 999,
    background: "var(--rv-azul-fundo)", color: "var(--rv-azul-texto)", fontSize: 12, fontWeight: 600, whiteSpace: "nowrap",
  },
