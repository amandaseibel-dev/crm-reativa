...
const S = {
  ...
  titulo: { fontSize: 12, fontWeight: 800, color: "var(--rv-ambar-texto)", marginBottom: 8, letterSpacing: 0.3 },
  ...
  rotulo: { fontSize: 13, color: "var(--rv-tinta)", fontWeight: 600 },
  quando: { fontSize: 12, color: "var(--rv-texto)" },
  bloqueio: { fontSize: 12, color: "var(--rv-texto)", fontStyle: "italic" },
  botao: {
    marginLeft: "auto",
    background: "#c2410c",
    color: "#fff",
  ...
  avisoOk: { background: "var(--rv-verde-ok-fundo)", color: "var(--rv-verde-ok-texto)", border: "1px solid var(--rv-verde-ok-borda)" },
  avisoErro: { background: "var(--rv-vermelho-fundo)", color: "var(--rv-vermelho-texto)", border: "1px solid var(--rv-vermelho-borda)" },
};
