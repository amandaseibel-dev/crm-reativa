...
export default function ConfirmarPagamento({ aluno }) {
  ...
  async function enviarParaConfirmacao() {
    ...
    // O operador só registra que o aluno disse ter pago (valor + observação).
    // Quem monta o acordo/parcelas (forma de pagamento, quantidade, entrada,
    // o que já está quitado etc.) é a Amanda, na fila de confirmação.
