...
const estilos = {
  ...
  menu: { position: "absolute", right: 0, top: "calc(100% + 6px)", zIndex: 50, width: 340, background: "var(--rv-superficie)", border: "1px solid var(--rv-borda)", borderRadius: 12, boxShadow: "0 14px 40px rgba(15,23,42,0.18)", padding: 12, display: "flex", flexDirection: "column", gap: 8 },
  titulo: { fontSize: 13, fontWeight: 800, color: "var(--rv-tinta)" },
  subtitulo: { fontSize: 12, fontWeight: 700, color: "var(--rv-texto)", marginBottom: 6 },
  blocoIndividual: { padding: 10, border: "1px solid var(--rv-borda-suave)", borderRadius: 10, background: "var(--rv-fundo-cartao)" },
  select: { flex: 1, minWidth: 150, padding: "7px 10px", borderRadius: 8, border: "1px solid var(--rv-borda)", fontSize: 12.5 },
  acao: { padding: "7px 12px", borderRadius: 8, border: "none", background: "#0f9d6b", color: "#fff", fontWeight: 700, fontSize: 12.5, cursor: "pointer" },
  item: { textAlign: "left", padding: "10px 12px", borderRadius: 8, border: "1px solid var(--rv-borda-suave)", background: "var(--rv-superficie)", color: "var(--rv-tinta)", fontSize: 13, fontWeight: 600, cursor: "pointer" },
  erro: { color: "var(--rv-vermelho-texto)", fontSize: 12.5 },
  rodape: { fontSize: 11, color: "var(--rv-texto-fraco)", marginTop: 2 },
};
