...
const S = {
  muted: { color: "var(--rv-texto-suave)", fontSize: 13 },
  aviso: { background: "var(--rv-ambar-fundo)", border: "1px solid var(--rv-ambar-borda)", color: "var(--rv-ambar-texto)", padding: 14, borderRadius: 10, fontSize: 13 },
  ...
  inputEmail: { flex: 1, minWidth: 180, border: "1px solid var(--rv-borda-forte)", borderRadius: 8, padding: "8px 10px", fontSize: 14 },
  btnSalvar: { background: "var(--rv-fundo-suave)", border: "1px solid var(--rv-borda-forte)", borderRadius: 8, padding: "8px 14px", fontWeight: 700, cursor: "pointer", color: "var(--rv-texto-forte)" },
  dest: { fontSize: 14, color: "var(--rv-tinta)", fontWeight: 600 },
  chips: { display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 14 },
  chip: { background: "var(--rv-fundo-suave)", border: "1px solid var(--rv-borda)", color: "var(--rv-texto-forte)", borderRadius: 999, padding: "7px 14px", fontSize: 13, cursor: "pointer" },
  ...
  preview: { marginTop: 6, border: "1px solid var(--rv-borda-suave)", borderRadius: 10, padding: 14, background: "var(--rv-superficie)", maxHeight: 360, overflowY: "auto" },
  anexoNota: { background: "var(--rv-azul-fundo)", border: "1px solid var(--rv-azul-borda)", color: "var(--rv-azul-texto)", padding: 10, borderRadius: 8, fontSize: 13, marginBottom: 12 },
  ...
  btnSec: { background: "var(--rv-superficie)", color: "var(--rv-azul-texto)", border: "1px solid #1d4ed8", borderRadius: 8, padding: "11px 16px", fontWeight: 700, cursor: "pointer" },
  msg: { marginTop: 12, background: "var(--rv-verde-ok-fundo)", border: "1px solid var(--rv-azul-borda)", color: "var(--rv-verde-ok-texto)", padding: 10, borderRadius: 8, fontSize: 13, fontWeight: 600 },
  msgErro: { marginTop: 12, background: "var(--rv-vermelho-fundo)", border: "1px solid var(--rv-vermelho-borda)", color: "var(--rv-vermelho-texto)", padding: 10, borderRadius: 8, fontSize: 13, fontWeight: 600 },
  rodape: { color: "var(--rv-texto-fraco)", fontSize: 12, marginTop: 10, lineHeight: 1.5 },
};
