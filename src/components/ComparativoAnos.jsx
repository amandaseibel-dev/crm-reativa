...
const S = {
  ...
  periodoTitulo: { margin: 0, fontSize: 14.5, fontWeight: 700, color: "#0f172a" },
  periodoBadge: {
    fontSize: 11.5, fontWeight: 800, color: "#b45309", background: "#fef3c7",
    border: "1px solid #fde68a", borderRadius: 999, padding: "4px 12px",
  },
