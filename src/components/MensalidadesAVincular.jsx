...
const S = {
  ...
  card: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda)", borderRadius: 14, padding: "12px 14px", display: "flex", flexDirection: "column", gap: 3, cursor: "pointer", textAlign: "left", font: "inherit" },
  cardAtivo: { borderColor: "#1e40af", boxShadow: "0 0 0 2px rgba(30,64,175,0.12)" },
  cardRot: { fontSize: 11.5, color: "var(--rv-texto-suave)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.04em" },
  cardVal: { fontSize: 21, fontWeight: 800, color: "var(--rv-tinta)", lineHeight: 1.1 },
  cardNota: { fontSize: 11.5, color: "var(--rv-texto-fraco)" },
  ...
  link: { color: "var(--rv-azul-texto)", fontWeight: 600, textDecoration: "none" },
  nota: { fontSize: 11, color: "var(--rv-texto-fraco)", marginLeft: 6, display: "inline-block" },
  ...
  rodape: { fontSize: 12, color: "var(--rv-texto-fraco)", margin: "12px 0 0" },
};
