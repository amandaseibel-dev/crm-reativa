...
const S = {
  ...
  modal: { background: "var(--rv-superficie)", borderRadius: 16, width: "100%", maxWidth: 440, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 50px rgba(0,0,0,0.35)", fontFamily: "Inter, system-ui, sans-serif" },
  header: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid var(--rv-borda)" },
  titulo: { fontSize: 16, color: "var(--rv-tinta)" },
  ...
  input: { padding: "9px 12px", borderRadius: 10, border: "1px solid var(--rv-borda)", fontSize: 13.5, fontFamily: "inherit" },
  labelCampo: { fontSize: 12.5, fontWeight: 700, color: "var(--rv-texto)" },
  inputFile: { fontSize: 12.5, fontFamily: "inherit", color: "var(--rv-texto)" },
  arquivoNome: { fontSize: 12, color: "var(--rv-verde-ok)", fontWeight: 700 },
  dica: { fontSize: 11.5, color: "var(--rv-ambar-texto)" },
  checkLinha: { display: "flex", gap: 8, alignItems: "flex-start", cursor: "pointer" },
  checkTexto: { fontSize: 12, color: "var(--rv-texto)", lineHeight: 1.4 },
  aviso: { background: "var(--rv-ambar-fundo)", border: "1px solid var(--rv-ambar-borda)", color: "var(--rv-ambar-texto)", borderRadius: 10, padding: "10px 12px", fontSize: 12, lineHeight: 1.5 },
  erro: { color: "var(--rv-vermelho)", fontSize: 13, margin: 0 },
  ...
  sucessoTxt: { fontSize: 15, color: "var(--rv-verde-ok-texto)", fontWeight: 700, margin: 0 },
};
