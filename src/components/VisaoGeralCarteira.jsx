...
export default function VisaoGeralCarteira() {
  ...
  const corSit = { "Em negociação": "var(--rv-verde-ok)", "Contatado": "var(--rv-azul)", "Sem negociar": "var(--rv-ambar)" };
  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={S.heroRow}>
        <Hero rot="Base total" cpfs={bt.cpfs} valor={bt.valor} sub={num(bt.titulos) + " títulos"} cor="var(--rv-texto-forte)" />
        <Hero rot="Operação · 2026" cpfs={op.cpfs} valor={op.valor} sub={num(op.titulos) + " títulos"} cor="var(--rv-azul-texto)" destaque />
        <Hero rot="Ação massiva · 2024-2025" cpfs={ms.cpfs} valor={ms.valor} sub={num(ms.titulos) + " títulos"} cor="var(--rv-ambar-texto)" />
        <Hero rot="Trabalhável" cpfs={tr.cpfs} valor={tr.valor} sub="tem telefone e ≥ R$100" cor="var(--rv-verde-ok)" />
      </div>
...
const S = {
  ...
  h2: { margin: 0, fontSize: 22, fontWeight: 800, color: "var(--rv-tinta)", letterSpacing: "-0.02em" },
  selo: { fontSize: 12, fontWeight: 700, color: "var(--rv-roxo-texto)", background: "var(--rv-roxo-fundo)", border: "1px solid var(--rv-roxo-borda)", borderRadius: 999, padding: "3px 12px" },
  heroRow: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: 14, marginBottom: 12 },
  hero: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 16, padding: "16px 18px", display: "flex", flexDirection: "column", gap: 5, boxShadow: "0 1px 2px rgba(15,23,42,0.04)" },
  heroDestaque: { background: "var(--rv-azul-fundo)", border: "1px solid var(--rv-azul-borda)", borderRadius: 16, padding: "16px 18px", display: "flex", flexDirection: "column", gap: 5, boxShadow: "0 1px 2px rgba(15,23,42,0.04)" },
  ...
  heroCpfs: { fontSize: 12, color: "var(--rv-texto-fraco)", fontWeight: 600 },
  miniRow: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: 14, marginBottom: 16 },
  mini: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 12, padding: "12px 16px", display: "flex", flexDirection: "column", gap: 3 },
  miniRot: { fontSize: 12, color: "var(--rv-texto-fraco)", fontWeight: 600 },
  miniVal: { fontSize: 15, fontWeight: 800, color: "var(--rv-texto-forte)" },
  grid2: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 14, marginBottom: 14 },
  bloco: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 16, padding: 18, marginBottom: 14, boxShadow: "0 1px 2px rgba(15,23,42,0.04)" },
  h3: { margin: "0 0 14px", fontSize: 14, fontWeight: 700, color: "var(--rv-tinta)" },
  ...
  track: { background: "var(--rv-fundo-suave)", borderRadius: 999, height: 10, overflow: "hidden" },
  fill: { height: "100%", borderRadius: 999 },
  tabelaWrap: { overflowX: "auto" },
  tabela: { width: "100%", borderCollapse: "collapse", fontSize: 13 },
  th: { textAlign: "left", padding: "9px 10px", color: "var(--rv-texto-fraco)", fontWeight: 600, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.04em", whiteSpace: "nowrap" },
  thNum: { textAlign: "right", padding: "9px 10px", color: "var(--rv-texto-fraco)", fontWeight: 600, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.04em", whiteSpace: "nowrap" },
  trOp: { background: "var(--rv-azul-fundo)" },
  tdMes: { padding: "9px 10px", fontWeight: 700, color: "var(--rv-texto-forte)", whiteSpace: "nowrap" },
  tag: { marginLeft: 6, background: "var(--rv-azul-fundo)", color: "var(--rv-azul-texto)", borderRadius: 999, padding: "1px 8px", fontSize: 10, fontWeight: 800 },
  td: { padding: "9px 10px", textAlign: "right", color: "var(--rv-texto-suave)", whiteSpace: "nowrap" },
  tdForte: { padding: "9px 10px", textAlign: "right", color: "var(--rv-tinta)", fontWeight: 700, whiteSpace: "nowrap" },
  tdOp: { padding: "9px 10px", textAlign: "right", color: "var(--rv-azul-texto)", fontWeight: 700, whiteSpace: "nowrap" },
  tdMs: { padding: "9px 10px", textAlign: "right", color: "var(--rv-ambar-texto)", fontWeight: 600, whiteSpace: "nowrap" },
  rodape: { color: "var(--rv-texto-fraco)", fontSize: 12, marginTop: 6 },
  card: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 16, padding: 18, marginBottom: 16 },
  muted: { color: "var(--rv-texto-suave)", margin: 0 },
};
