...
const S = {
  ...
  modal: { background: "var(--rv-superficie)", color: "var(--rv-tinta)", borderRadius: 18, width: "min(480px, 100%)", maxHeight: "90vh", overflow: "auto", boxShadow: "0 24px 70px rgba(0,0,0,0.4)", padding: 24 },
  cabecalho: { marginBottom: 16 },
  tag: { display: "inline-block", fontSize: 12, fontWeight: 800, color: "var(--rv-roxo)", background: "var(--rv-roxo-fundo)", borderRadius: 999, padding: "4px 12px", marginBottom: 10 },
  titulo: { fontSize: 22, fontWeight: 800, margin: "0 0 4px" },
  sub: { fontSize: 14, color: "var(--rv-texto-suave)", margin: 0 },
  ...
  itemTitulo: { fontSize: 14.5, fontWeight: 800, color: "var(--rv-tinta)" },
  itemTexto: { fontSize: 13, color: "var(--rv-texto)", lineHeight: 1.45, marginTop: 2 },
  ...
  rodape: { fontSize: 12, color: "var(--rv-texto-fraco)", textAlign: "center", margin: "10px 0 0" },
};
