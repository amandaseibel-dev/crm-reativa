...
const S = {
  ...
  sub: { margin: "6px 0 18px", color: "var(--rv-texto-suave)", fontSize: 13.5, maxWidth: 760, lineHeight: 1.6 },
  ...
  cardOk: { background: "var(--rv-verde-ok-fundo)", border: "1px solid var(--rv-verde-ok-borda)", borderRadius: 16, padding: 18, marginBottom: 16, display: "flex", flexDirection: "column", gap: 10, alignItems: "flex-start" },
  ...
  btnSec: { background: "var(--rv-superficie)", color: "var(--rv-verde-ok-texto)", border: "1px solid var(--rv-verde-ok-borda)", borderRadius: 10, padding: "8px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" },
