...
const estilos = {
  ...
  botaoAbaAtiva: { background: "#0d6efd", color: "#fff", borderColor: "#0d6efd" },
  card: { background: "#111827", borderRadius: 12, padding: 18, marginBottom: 16 },
  linhaTopo: {
    display: "flex",
  ...
  aviso: { fontSize: 13, color: "#fcd34d" },
};
