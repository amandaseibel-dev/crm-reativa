...
const s = {
  ...
  sub: { color: "var(--rv-texto-suave)", fontSize: 13, margin: "6px 0 16px" },
  card: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 14, padding: 18, marginBottom: 16 },
  h3: { margin: "0 0 12px", fontSize: 15, color: "var(--rv-tinta)" },
  ...
  tagWarn: { background: "var(--rv-ambar-fundo)", color: "var(--rv-ambar-texto)", borderRadius: 6, padding: "2px 6px", fontSize: 12, fontWeight: 700 },
  ...
  erro: { background: "var(--rv-vermelho-fundo)", border: "1px solid var(--rv-vermelho-borda)", color: "var(--rv-vermelho-texto)", padding: 12, borderRadius: 10, marginBottom: 16, fontSize: 13 },
  ok: { background: "var(--rv-verde-ok-fundo)", border: "1px solid var(--rv-azul-borda)", color: "var(--rv-verde-ok-texto)", padding: 12, borderRadius: 10, marginBottom: 16, fontSize: 13, fontWeight: 600 },
  ...
  avisoInline: { background: "var(--rv-ambar-fundo)", border: "1px solid var(--rv-ambar-borda)", color: "var(--rv-ambar-texto)", padding: 10, borderRadius: 8, marginTop: 12, fontSize: 12.5 },
};
