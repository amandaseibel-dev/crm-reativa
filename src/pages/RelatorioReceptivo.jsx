...
const S = {
  wrap: { padding: 24, fontFamily: "'Inter', system-ui, sans-serif", background: "var(--rv-fundo)", minHeight: "100%" },
  head: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, marginBottom: 18, flexWrap: "wrap" },
  h1: { margin: 0, fontSize: 24, color: "var(--rv-tinta)", fontWeight: 800 },
  ...
  card: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 14, padding: "16px 18px", display: "flex", flexDirection: "column", gap: 4, boxShadow: "0 1px 3px rgba(15,23,42,0.05)" },
  cardVal: { fontSize: 28, fontWeight: 800, color: "var(--rv-tinta)" },
  cardRot: { fontSize: 12, color: "var(--rv-texto-suave)", fontWeight: 600 },
  box: { background: "var(--rv-superficie)", border: "1px solid var(--rv-borda-suave)", borderRadius: 14, padding: 18, boxShadow: "0 1px 3px rgba(15,23,42,0.05)" },
  h3: { margin: "0 0 12px", fontSize: 15, fontWeight: 700, color: "var(--rv-tinta)" },
  tabela: { width: "100%", borderCollapse: "collapse", fontSize: 13.5 },
  th: { textAlign: "left", padding: "8px 10px", color: "var(--rv-texto-suave)", fontSize: 11, fontWeight: 700, textTransform: "uppercase", borderBottom: "1px solid var(--rv-borda)" },
  thNum: { textAlign: "right", padding: "8px 10px", color: "var(--rv-texto-suave)", fontSize: 11, fontWeight: 700, textTransform: "uppercase", borderBottom: "1px solid var(--rv-borda)" },
  td: { padding: "10px", borderBottom: "1px solid var(--rv-borda-suave)", fontWeight: 700, color: "var(--rv-tinta)" },
  tdNum: { padding: "10px", borderBottom: "1px solid var(--rv-borda-suave)", textAlign: "right", color: "var(--rv-texto-forte)" },
  barTrack: { display: "inline-block", width: 80, height: 6, background: "var(--rv-fundo-suave)", borderRadius: 999, overflow: "hidden", marginRight: 8, verticalAlign: "middle" },
