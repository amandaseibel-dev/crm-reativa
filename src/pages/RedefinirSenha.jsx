...
const estilos = {
  ...
  titulo: { margin: "0 0 6px", fontSize: 20, fontWeight: 800, color: "var(--rv-tinta)" },
  texto: { margin: "0 0 18px", fontSize: 13.5, color: "var(--rv-texto-fraco)" },
  label: { display: "block", fontSize: 12, fontWeight: 700, color: "var(--rv-texto)", marginBottom: 5, marginTop: 12 },
  input: {
    width: "100%",
    padding: "10px 12px",
    borderRadius: 10,
  ...
  erro: { color: "var(--rv-vermelho-texto)", fontSize: 13, marginTop: 12 },
  botao: {
    width: "100%",
    marginTop: 20,
    background: "#1e40af",
