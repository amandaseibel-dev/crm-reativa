...
const estilos = {
  ...
  tendenciaBarra: { width: 6, borderRadius: 2, background: "#0f9d6b" },
  botaoAcao: { background: "#0f9d6b", color: "#fff", border: "none", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 12.5, cursor: "pointer" },
