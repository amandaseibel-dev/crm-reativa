...
const styles = {
  ...
  cardBaixa: { background: "var(--rv-superficie)", borderRadius: "16px", padding: "20px", marginBottom: "16px", boxShadow: "0 2px 10px rgba(0,0,0,0.08)", borderLeft: "6px solid #198754" },
  ...
  status: { background: "var(--rv-borda)", color: "var(--rv-texto-forte)", padding: "8px 12px", borderRadius: "999px", fontWeight: "bold", fontSize: "13px" },
  obs: { background: "var(--rv-fundo-cartao)", border: "1px solid var(--rv-borda)", borderRadius: "10px", padding: "12px", marginTop: "12px", color: "var(--rv-texto-forte)" },
