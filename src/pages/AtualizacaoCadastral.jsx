...
const S = {
  ...
  subtitulo: { color: "var(--rv-texto-suave)", marginTop: 8, marginBottom: 0, maxWidth: 760, lineHeight: 1.5 },
  grade: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(170px, 1fr))", gap: 12, marginTop: 18 },
  numero: { border: "1px solid var(--rv-borda)", borderRadius: 12, padding: "12px 14px", background: "var(--rv-superficie)", display: "flex", flexDirection: "column", gap: 2 },
  numeroDestaque: { background: "var(--rv-fundo-suave)", borderColor: "transparent" },
  numeroRot: { fontSize: 11.5, letterSpacing: ".03em", textTransform: "uppercase", color: "var(--rv-texto-suave)", fontWeight: 700 },
  numeroVal: { fontSize: 21, fontWeight: 800, color: "var(--rv-tinta)", fontVariantNumeric: "tabular-nums" },
  rodape: { fontSize: 12.5, color: "var(--rv-texto-suave)", marginTop: 10 },
  caixaAcao: { marginTop: 20, display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap", border: "1px solid var(--rv-borda)", borderRadius: 12, padding: 16, background: "var(--rv-superficie)" },
  label: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, fontWeight: 600, color: "var(--rv-texto-forte)" },
  select: { border: "1px solid var(--rv-borda-forte)", borderRadius: 8, padding: "8px 10px", fontSize: 13 },
  ...
  aviso: { fontSize: 12.5, color: "var(--rv-texto-suave)", flex: 1, minWidth: 220 },
  rodando: { marginTop: 12, fontSize: 13, color: "var(--rv-ambar-texto)", fontWeight: 600 },
  erro: { marginTop: 12, fontSize: 13, color: "var(--rv-vermelho-texto)", fontWeight: 600 },
  resultado: { marginTop: 22 },
  resultadoTitulo: { fontFamily: "'Sora', Inter, sans-serif", fontSize: 15, fontWeight: 800, color: "var(--rv-tinta)" },
  nota: { fontSize: 12.5, color: "var(--rv-texto-suave)", marginTop: 10, lineHeight: 1.5 },
};
