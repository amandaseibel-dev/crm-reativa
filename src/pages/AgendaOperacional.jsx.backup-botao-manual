...
export default function AgendaOperacional() {
  ...
  if (carregando) {
    return <div style={styles.container}>Carregando Agenda Operacional...</div>;
  }
