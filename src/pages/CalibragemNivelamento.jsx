...
const estilos = {
  ...
  sub: { color: "var(--rv-texto-fraco)", fontSize: 13.5, margin: 0 },
  toolbar: { display: "flex", gap: 18, flexWrap: "wrap", alignItems: "center", marginBottom: 16 },
  grp: { display: "flex", flexDirection: "column", gap: 6 },
  lbl: { fontSize: 10, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--rv-texto-suave)", fontWeight: 700 },
  chips: { display: "flex", gap: 6, flexWrap: "wrap" },
  chip: { background: "#0b1424", border: "1px solid #22304a", color: "var(--rv-texto-fraco)", borderRadius: 999, padding: "6px 14px", fontSize: 13, fontWeight: 600, cursor: "pointer" },
  ...
  rk: { fontSize: 10, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--rv-texto-suave)", fontWeight: 700 },
  rv: { fontSize: 19, fontWeight: 800, marginTop: 2 },
  rsub: { fontSize: 10.5, color: "var(--rv-texto-suave)", fontWeight: 600, marginTop: 1 },
  ...
  st: { fontSize: 11, color: "var(--rv-texto-suave)", marginTop: 1 },
  ...
  saldoS: { display: "block", color: "var(--rv-texto-suave)", fontSize: 10, fontWeight: 600 },
  ...
  btnGhost: { background: "transparent", border: "1px solid #22304a", color: "var(--rv-texto-fraco)", borderRadius: 10, padding: "12px 18px", fontSize: 14, fontWeight: 700, cursor: "pointer" },
  ...
  nota: { fontSize: 11, color: "var(--rv-texto-suave)", marginTop: 12, fontStyle: "italic", lineHeight: 1.5 },
};
