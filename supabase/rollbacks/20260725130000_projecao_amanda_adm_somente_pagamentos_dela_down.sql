-- ROLLBACK de 20260725130000_projecao_amanda_adm_somente_pagamentos_dela.sql
-- Restaura a versao do PR #51 (migration 20260725120000): a Amanda ADM volta
-- a enxergar ranking e historico da filial (v_e_admin_amanda). Mantem a
-- assinatura (text,text,text) e o helper projecao_unidades_disponiveis().
