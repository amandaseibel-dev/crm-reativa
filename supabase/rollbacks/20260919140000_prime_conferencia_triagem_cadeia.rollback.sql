-- ROLLBACK do ajuste 2 da triagem (20260919140000): devolve a funcao ao texto
-- de 20260919120000 e retria. Nao toca em decisao, titulo ou financeiro.
begin;
...
$function$;
select public.prime_conferencia_triagem_recalcular(null);
commit;
