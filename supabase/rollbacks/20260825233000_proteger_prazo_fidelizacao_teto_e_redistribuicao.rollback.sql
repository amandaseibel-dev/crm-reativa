-- ============================================================================
-- ROLLBACK de 20260825233000_proteger_prazo_fidelizacao_teto_e_redistribuicao
-- Restaura as 4 funcoes ao estado anterior: trg_impor_teto_operador,
-- reforcar_teto_operadores (incl. o grant para authenticated),
-- redistribuir_casos_operadores e redistribuir_casos_operadores_faixas.
-- Reabre o furo dos 10 dias no teto -- usar so em emergencia.
-- ============================================================================
...
grant execute on function public.reforcar_teto_operadores() to authenticated;
