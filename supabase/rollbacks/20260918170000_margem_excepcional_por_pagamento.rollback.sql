-- ROLLBACK de 20260918170000_margem_excepcional_por_pagamento.sql
-- Devolve previa 580559d1 e registrador 5746cfee; remove funcao e tabela.
...
drop function if exists public.pagamento_autorizar_margem_excepcional(uuid, text);
drop table if exists public.pagamento_margem_autorizada;
