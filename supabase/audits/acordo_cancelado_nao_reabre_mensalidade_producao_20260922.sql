-- AUDITORIA -- corpos EXATOS de producao em 22/09/2026, antes da migration
-- 20260922265000_acordo_cancelado_nao_reabre_mensalidade_negociada.sql.
-- Capturados via pg_get_functiondef no projeto de producao (ahattpqrjmhkzsmnbdzs).
-- NAO EXECUTAR: e material de comparacao, nao uma migration.

-- ---------------------------------------------------------------------------
-- public.titulo_reavaliar(uuid) -- ja inclui a guarda de CANCELADA de 13/09
-- (migration 20260913230000_titulo_reavaliar_cancelada_e_estado_terminal.sql).
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- public.titulos_por_status_acordo() -- trigger em acordos, AFTER UPDATE OF status
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- public.cancelar_acordo_ficha(uuid) -- RPC chamada pela tela (FinanceiroAluno.jsx)
-- ---------------------------------------------------------------------------
