-- CONFERENCIA PRIME -- rota financeira do pagamento 71706 (R4), autorizada pela gestao em 18/09/2026.
...
do $rota$
declare
  c_bol   constant text   := '71706';
  c_pag   constant uuid   := 'f8785717-f67b-442a-966e-3b53607e4022';
  c_tits  constant uuid[] := array['1251a48b-bcf2-47f2-96be-11682ff26fde']::uuid[];
  c_sol   constant uuid   := '432658a2-0523-49a4-97c1-7971138857c7';
  c_mot   constant text   := 'ROTA_FINANCEIRA_PAGAMENTO: Conferencia Prime, gestao 18/09/2026. O titulo segue pela rota do pagamento '
                             || '71706 (acordo a vista registrado pelo pagamento na mesma transacao).';
