-- CONFERENCIA PRIME -- rota financeira do pagamento 71787 (R4), autorizada pela gestao em 18/09/2026.
...
do $rota$
declare
  c_bol   constant text   := '71787';
  c_pag   constant uuid   := '30b15fc3-c46a-41c3-9036-e526b2994bd7';
  c_tits  constant uuid[] := array['06a70a38-10e9-425d-86f2-47655dab90f4','02b87028-113e-45a5-b555-91db07430a6d','e94b58ad-58df-4fbc-94a5-5d1d74184ab3']::uuid[];
  c_sol   constant uuid   := '75f80d59-82fc-49a0-9f42-89394e35d25b';
  c_mot   constant text   := 'ROTA_FINANCEIRA_PAGAMENTO: Conferencia Prime, gestao 18/09/2026. O titulo segue pela rota do pagamento '
                             || '71787 (acordo a vista registrado pelo pagamento na mesma transacao).';
