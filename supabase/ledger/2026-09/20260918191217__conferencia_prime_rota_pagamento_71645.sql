-- CONFERENCIA PRIME -- rota financeira do pagamento 71645 (R4), autorizada pela gestao em 18/09/2026.
...
do $rota$
declare
  c_bol   constant text   := '71645';
  c_pag   constant uuid   := '3d78b770-4751-49d3-98ed-ae92a6a64764';
  c_tits  constant uuid[] := array['b88f9874-28da-409a-932d-3553817520f9','11066542-b9ce-4293-9870-d57a8cb1fdad']::uuid[];
  c_sol   constant uuid   := '5709460c-4332-4540-8e63-8814eadbe56d';
  c_mot   constant text   := 'ROTA_FINANCEIRA_PAGAMENTO: Conferencia Prime, gestao 18/09/2026. O titulo segue pela rota do pagamento '
                             || '71645 (acordo a vista registrado pelo pagamento na mesma transacao).';
