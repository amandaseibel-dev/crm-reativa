-- CONFERENCIA PRIME -- L1 COM OUTRA DIVIDA (opcao 1), faixa 2 de 3 (alunos com id em [8, b)).
...
do $l1b$
declare
  c_faixa  constant int  := 2;
  c_ini    constant text := '8';
  c_fim    constant text := 'b';
  c_obs    constant text := 'Lote L1 com outra divida (opcao 1) autorizado pela gestao em 18/09/2026; execucao em lote, faixa 2 de 3.';
