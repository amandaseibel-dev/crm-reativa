-- CONFERENCIA PRIME -- L1 QUITACAO TOTAL, fatia 2 de 8.
...
do $l1q$
declare
  c_fatia  constant int  := 2;
  c_tam    constant int  := 43;
  c_obs    constant text := 'Lote L1 quitacao total autorizado pela gestao em 18/09/2026 (CONFIRMACAO_PRIME_QUITACAO_TOTAL_AUTORIZADA); execucao em lote, fatia 2 de 8.';
