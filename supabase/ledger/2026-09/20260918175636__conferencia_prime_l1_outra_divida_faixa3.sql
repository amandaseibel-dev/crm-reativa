-- CONFERENCIA PRIME -- L1 COM OUTRA DIVIDA (opcao 1), faixa 3 de 3 (alunos com id em [b, g)).
...
do $l1b$
declare
  c_faixa  constant int  := 3;
  c_ini    constant text := 'b';
  c_fim    constant text := 'g';
  c_obs    constant text := 'Lote L1 com outra divida (opcao 1) autorizado pela gestao em 18/09/2026; execucao em lote, faixa 3 de 3.';
