-- ============================================================================
-- Fechamento: relatorio exibe NOME COMPLETO (do DRE), nao apelido/e-mail.
-- Decisao Amanda 2026-08-04: carregar o nome completo cadastrado no sistema.
-- calcular_fechamento_remuneracao passa a trazer dre_funcionario.nome no campo
-- 'nome' de cada beneficiario (operadores e gestao); fallback ao nome do
-- pagamento/rotulo se nao houver match no DRE.
-- ============================================================================
...
declare
  ...
  v_sal_dre numeric; v_nome_dre text;
