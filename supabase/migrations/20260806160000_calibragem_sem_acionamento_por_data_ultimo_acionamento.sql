-- ============================================================================
-- Calibragem: ancorar "sem acionamento" na coluna canônica data_ultimo_acionamento
-- em vez de status_acionamento.
--
-- Motivo: o chip "Sem acionamento" contava casos.status_acionamento IS NULL, que
-- diverge da regra de todas as outras telas (Saúde da Carteira, Painel do operador),
-- que usam data_ultimo_acionamento. Um caso podia ter data_ultimo_acionamento
-- preenchida (já acionado) mas status_acionamento nulo, sendo contado como
-- "sem acionamento" por engano — inflando o número por operador.
--
-- Mudança (somente os indicadores sem_acion_* e sem_recente_*):
--   sem_acionamento          = data_ultimo_acionamento IS NULL            (nunca acionado)
--   sem_acionamento_recente  = data_ultimo_acionamento IS NOT NULL
--                              AND data_ultimo_acionamento < current_date - 10
-- Restante do corpo e o gate técnico permanecem idênticos.
-- ============================================================================
