-- ============================================================================
-- Fechamento: comissao TRUNCADA em centavos (sem arredondamento pra cima).
-- Decisao Amanda 2026-08-04: valor exato, sem arredondar. Vale p/ TODAS as
-- comissoes (faixa, percentual fixo e override de gestao). round()->trunc()
-- apenas nas comissoes; falta-p/-faixa e reconciliacao seguem em round().
-- Ex.: 3% de 554.666,54 = 16.639,9962 -> 16.639,99 (antes 16.640,00).
-- ============================================================================
