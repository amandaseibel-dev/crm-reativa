-- A CONFERENCIA passa a comparar o extrato com o RELATORIO DE BAIXA.
--
-- Amanda: "o que preciso e conciliar os alunos santander ao relatorio de baixa
-- por valor pago, nao localizei essa mudanca ainda" -- e ela estava certa, essa
-- conciliacao nao existia. A que havia comparava o extrato com o SALDO, nao com
-- o que foi baixado. Depois: "deixa no financeiro fila de conferencia, um lugar
-- so".
--
-- O relatorio de baixa e `baixas_pagamento`: 1.666 baixas REALIZADAS em julho e
-- agosto, R$ 3.010.368,44, contra R$ 11,7 mi que entraram no extrato.
--
-- A CONCILIACAO, medida em 31/08/2026 (jul+ago):
--   so no relatorio de baixa    174 alunos  R$   945.230,78  baixamos e o extrato nao mostra
--   so no extrato             1.768 alunos  R$ 4.360.347,30  entrou e nao foi baixado
--   nos dois, valor bate        130
--   nos dois, valor DIVERGE     288         diferenca de R$ 406.356,07
--
-- Parte da divergencia e esperada: pagamento a vista vem maior que o principal
-- (premissa 17). Por isso a linha mostra os DOIS numeros lado a lado e nao
-- classifica -- quem julga e a pessoa. Os selos so apontam: "baixa sem lastro" e
-- "baixa != extrato".
--
-- O UNIVERSO CRESCE. Antes: aluno com pagamento nao conferido. Agora: aluno com
-- pagamento nao conferido OU com baixa na janela -- senao os que so tem baixa
-- ficariam invisiveis, e foi para eles nao sumirem que tudo veio para um lugar
-- so. Na fila: 1.471 alunos (era 1.365) mais 1.314 sem vinculo = 2.785 linhas.
--
-- Continua valendo: saldo ZERO fica fora ("os que estao zerado ja foram
-- conferidos").
--
-- `baixas_pagamento.aluno_id` e TEXT e nem sempre e uuid -- dai o guarda de
-- formato antes do cast.
