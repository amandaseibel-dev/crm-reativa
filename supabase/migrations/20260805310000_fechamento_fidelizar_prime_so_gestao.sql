-- ============================================================================
-- Fechamento: fidelizar Prime SO na gestao (Amanda 3% / Fernanda 1,5%).
-- Ajuste Amanda 2026-08-05: os OPERADORES voltam a comissionar sobre o
-- honorario AO VIVO (sistema); apenas a base da GESTAO usa o total do Prime
-- (quando ha conferencia do mes). Reverte a fidelizacao dos operadores da
-- migration 20260805300000, mantendo a gestao fidelizada.
-- ============================================================================
...
begin
  ...
  loop
    ...
    -- Operadores: base sempre AO VIVO (sistema). So a gestao e fidelizada ao Prime.
