-- ============================================================================
-- Fechamento de Remuneracao: SALARIO (valor fixo) vem do DRE (fonte unica).
-- ----------------------------------------------------------------------------
-- Decisao Amanda 2026-08-04: o salario ja esta cadastrado no DRE
-- (dre_funcionario.salario_base). Em vez de redigitar no fechamento, o
-- calcular_fechamento_remuneracao passa a LER o salario do DRE, ligando cada
-- funcionario ao e-mail do operador via nova coluna dre_funcionario.operador_email.
-- Vale p/ operadores E gestao. Premiacao NAO vem daqui (fica na aba Premiacoes
-- do fechamento / dre_folha, ainda vazia p/ julho).
-- ============================================================================

alter table public.dre_funcionario add column if not exists operador_email text;

-- Ligacao funcionario DRE -> operador (confirmada por usuarios.email x nome).
update public.dre_funcionario set operador_email = 'cobranca03@aelbra.com.br' where nome = 'Olga Patrícia de Oliveira';
update public.dre_funcionario set operador_email = 'cobranca05@aelbra.com.br' where nome = 'Luana Litchina Marques';
update public.dre_funcionario set operador_email = 'cobranca06@aelbra.com.br' where nome = 'Maurício Eilert Feijó';
update public.dre_funcionario set operador_email = 'cobranca08@aelbra.com.br' where nome = 'Nataly das Neves Pereira';
update public.dre_funcionario set operador_email = 'cobranca10@aelbra.com.br' where nome = 'João Vitor Hansen da Silva';
update public.dre_funcionario set operador_email = 'cobranca11@aelbra.com.br' where nome = 'Allan Silva da Silva';
update public.dre_funcionario set operador_email = 'cobranca12@aelbra.com.br' where nome = 'Rafaella Avila da Silva Coimbra';
update public.dre_funcionario set operador_email = 'cobranca13@aelbra.com.br' where nome = 'Diego Rodrigues Cruz';
update public.dre_funcionario set operador_email = 'cobranca07@aelbra.com.br' where nome = 'Amanda Krishna Verch Borges';
update public.dre_funcionario set operador_email = 'cobranca04@aelbra.com.br' where nome = 'Fernanda Avila Maciel';
update public.dre_funcionario set operador_email = 'amanda.seibel@aelbra.com.br' where nome = 'Amanda Prado Seibel';

create index if not exists idx_dre_funcionario_operador_email on public.dre_funcionario (lower(operador_email)) where operador_email is not null;
...
begin
  ...
  loop
    ...
    select salario_base into v_sal_dre from public.dre_funcionario
    ...
    v_benef := v_benef || jsonb_build_object('email', r.email, 'nome', coalesce(r.nome, r.email),
  ...
  loop
    ...
    v_benef := v_benef || jsonb_build_object('email', r.email, 'nome', r.nome,
