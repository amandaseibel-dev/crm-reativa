-- ============================================================================
-- Agendamento de Ações Massivas — propaga o filtro situacao_academica
-- ============================================================================
-- Complementa 20260805270000: o agendador (estimativa + executor técnico)
-- passa a honrar filtros->>'situacao_academica'. Sem isso, agendar uma campanha
-- filtrando por status acadêmico ignoraria o filtro silenciosamente.
-- Reproduz fielmente as funções de 20260805220000 + 1 condição/argumento novo.
-- Nada muda para agendamentos existentes (filtro ausente = NULL = não filtra).
-- ============================================================================

-- 1) ESTIMATIVA (gestão): repassa o 8º argumento à prévia.
...
-- 2) EXECUTOR TÉCNICO: acrescenta a condição de situacao_academica na revalidação.
